...
#a, b = np.shape(these_sobs)
#ts = np.zeros([a, b+1])
#for i in range(a):
#    ts[i] = np.append(MolWt(mymols[i]), these_sobs[i])
#
#from sklearn.preprocessing import minmax_scale, StandardScaler
#scaler = StandardScaler()
#these_sobs = scaler.fit_transform(these_sobs)
#these_sobs = minmax_scale(ts, feature_range=(-1,1))
